...
function popularServices($count = 20, $isPagination = false)
{
    $query = Service::select('id', 'price_per_person', 'slug','country', 'location', 'is_featured', 'full_price', 'discount_price', 'is_new', 'duration', 'group_size', 'service_type_id', 'destination_id')
        ->where('status', true)
