...
Route::group(['as' => 'admin.tourbooking.', 'prefix' => 'admin/tourbooking', 'middleware' => ['auth:admin']], function () {
    ...
    // Destinations admin.tourbooking.destinations.index
        Route::resource('destinations', DestinationController::class);
        Route::resource('domestic', DestinationController::class);
        Route::resource('international', DestinationController::class);
...
Route::group(['as' => 'front.tourbooking.', 'prefix' => 'tour-booking', 'middleware' => ['web']], function () {
    ...
    Route::post('/enquiry/store', [FrontBookingController::class, 'store'])->name('enquiry.store');

    Route::get('/hotel/details', [FrontServiceController::class, 'hotelDetails'])
    ->name('front.hotel.details');
