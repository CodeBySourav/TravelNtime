...
Route::group(['as' => 'admin.', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::controller(FrontEndManagementController::class)->name('front-end.')->group(function () {
            ...
            // ✅ Our Working Process
            Route::get('frontend-section/working-process', 'workingProcess')->name('working-process');
            Route::post('frontend-section/working-process', 'workingProcessStore')->name('working-process-store');
        });
    });
});
