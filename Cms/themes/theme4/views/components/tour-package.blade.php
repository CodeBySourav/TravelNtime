...
<div class="tg-listing-area pt-50 pb-120 p-relative" style="background-color: #ffffff;">
    ...
    <div class="container">
        ...
        {{-- ================= DOMESTIC PACKAGES ================= --}}
        @if ($domesticPackages->count() > 0)
            <div class="row mb-40">
                <div class="col-12">
                    <h3 class="text-center mb-30">Domestic Tour Packages</h3>
                </div>

                @foreach ($domesticPackages as $service)
                ...
                <div class="col-12">
                    <div class="text-center mt-15">
                        <a href="{{ url('tour-booking/services') }}?service_type_ids[]=2"
        ...
        @if ($internationalPackages->count() > 0)
            <div class="row mt-40">
                <div class="col-12">
                    <h3 class="text-center mb-30">International Tour Packages</h3>
                </div>

                @foreach ($internationalPackages as $service)
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                            <div class="tg-listing-card-thumb fix mb-25 p-relative">
                                <a href="{{ route('front.tourbooking.services.show', ['slug' => $service?->slug]) }}">
