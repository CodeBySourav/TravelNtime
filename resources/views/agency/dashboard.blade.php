...
@section('body-content')
    ...
    <div class="d-inline-flex justify-content-center align-items-center bg-primary-white rounded-circle grid-icon-size">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <path
                ...
                stroke="#aa0022" stroke-width="1.5" stroke-linecap="round">
            </path>
            <path d="M15 11H18" stroke="#aa0022" stroke-width="1.5" stroke-linecap="round"></path>
        </svg>
    </div>
</span>
    ...
    <div class="d-inline-flex justify-content-center align-items-center bg-primary-white rounded-circle grid-icon-size">
        <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#aa0022" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <defs>
                <clipPath id="clip0_5109_274">
                    <rect width="9" height="9" fill="white" transform="translate(12 9)"></rect>
                </clipPath>
            </defs>
        </svg>
    </div>
    ...
    <div class="d-inline-flex justify-content-center align-items-center bg-primary-white rounded-circle grid-icon-size">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <path
                ...
                stroke="#aa0022" stroke-width="1.5"></path>
            <path
                ...
                stroke="#aa0022" stroke-width="1.5" stroke-linejoin="round"></path>
            <path
    ...
    <div class="d-inline-flex justify-content-center align-items-center bg-primary-white rounded-circle grid-icon-size">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="10" stroke="#aa0022" stroke-width="1.5"></circle>
            <path
                d="M14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10C10 11.1046 10.8954 12 12 12"
                stroke="#aa0022" stroke-width="1.5" stroke-linecap="round"></path>
            <path
                d="M12 12C13.1046 12 14 12.8954 14 14C14 15.1046 13.1046 16 12 16C10.8954 16 10 15.1046 10 14"
                stroke="#aa0022" stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M12 6.5V8" stroke="#aa0022" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M12 16V17.5" stroke="#aa0022" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
    </div>
</span>
...
// OLD COLORS (remove these lines)
// gradientBgs.addColorStop(0, 'rgba(100, 64, 251, 0.1');
// gradientBgs.addColorStop(1, 'rgba(100, 64, 251, 0.5)');

// ✅ NEW RED COLORS
gradientBgs.addColorStop(0, 'rgba(170, 0, 34, 0.1)');
gradientBgs.addColorStop(1, 'rgba(170, 0, 34, 0.5)');
    ...
    borderColor: '#aa0022',        // ✅ Line color
    pointBackgroundColor: '#aa0022', // ✅ Point color
    pointBorderColor: '#aa0022',
    borderWidth: 3,
    fill: true,
    tension: 0.4,
    fillColor: '#fff',
    ...
    grid: {
        color: '#F3D8DD',  // Optional: light red grid
    },
},
y: {
    ticks: {
